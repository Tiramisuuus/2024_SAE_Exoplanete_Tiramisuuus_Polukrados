        ...
        try {
            ...
            for (int y = 0; y < originalImage.getHeight(); y++) {
                for (int x = 0; x < originalImage.getWidth(); x++) {
                    ...
                    int moyenne = (tabColor[0] + tabColor[1] + tabColor[2]) / 3;
                    Color gris = new Color(moyenne, moyenne, moyenne);
                    newImage.setRGB(x, y, gris.getRGB());
                }
            }

            File outputfile = new File("src/assets/" + nomFichier1 + "_copieNoirEtBlanc.png");
